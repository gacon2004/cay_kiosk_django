    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=10,
                        verbose_name="Giá dịch vụ không bảo hiểm",
                    ),
                ),
                (
                    "prices_insurance",
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=10,
                        verbose_name="Giá dịch vụ có bảo hiểm",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("gender", models.BooleanField(verbose_name="Giới tính")),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["insurance_id"], name="kiosk_insur_insuran_110c76_idx"
                    ),
                    models.Index(
                        fields=["expired"], name="kiosk_insur_expired_48a145_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Địa chỉ"
                    ),
                ),
                (
                    "occupation",
                ...
                (
                    "is_insurance",
                    models.BooleanField(default=False, verbose_name="Có bảo hiểm"),
                ),
                (
                    "ethnicity",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["citizen_id"], name="kiosk_patie_citizen_ad6dc9_idx"
                    ),
                    models.Index(
                        fields=["fullname"], name="kiosk_patie_fullnam_d4717f_idx"
                    ),
                    models.Index(
                        fields=["-created_at"], name="kiosk_patie_created_05c920_idx"
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["employee_id"], name="custom_user_employe_e22f63_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
        ...
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["department"], name="custom_user_departm_d2743f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="doctors",
            index=models.Index(
                fields=["doctor_id"], name="kiosk_docto_doctor__c41081_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="doctors",
            index=models.Index(
                fields=["specialization"], name="kiosk_docto_special_dc5684_idx"
            ),
        ),
    ]
