...
class PatientViewSet(viewsets.ModelViewSet):
    ...
    - GET /api/users/patients/ - Lấy danh sách bệnh nhân
    - POST /api/users/patients/ - Tạo bệnh nhân mới
    - GET /api/users/patients/{id}/ - Xem chi tiết bệnh nhân
    - PUT /api/users/patients/{id}/ - Cập nhật bệnh nhân
    - PATCH /api/users/patients/{id}/ - Cập nhật một phần
    - DELETE /api/users/patients/{id}/ - Xóa bệnh nhân
    
    Custom actions:
    - GET /api/users/patients/with_insurance/ - Lấy danh sách bệnh nhân có BHYT
    - GET /api/users/patients/search_by_national_id/?national_id=xxx - Tìm theo CMND
    """
    ...
    def with_insurance(self, request):
        """
        GET /api/users/patients/with_insurance/
    ...
    def search_by_national_id(self, request):
        """
        GET /api/users/patients/search_by_national_id/?national_id=xxx
    ...
    def insurances(self, request, pk=None):
        """
        GET /api/users/patients/{id}/insurances/
        Lấy danh sách bảo hiểm của bệnh nhân
        """
        patient = self.get_object()
        from apps.users.serializers import InsuranceSerializer
